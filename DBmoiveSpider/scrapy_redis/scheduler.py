...
class Scheduler(object):
    def __init__(self, server, persist, queue_key, queue_cls, dupefilter_key):
        ...
        persist : bool, Whether to flush requests when closing. Default is False, not flush information in redis.
        queue_key : str, Requests queue key.
        queue_cls : queue class, Importable path to the queue class.
        dupefilter_key : str, Duplicates filter key.
        """
        self.server = server
